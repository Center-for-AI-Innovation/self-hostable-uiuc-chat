...
> = {
  ...
  [OpenAICompatibleModelID.GPT_5_5]: {
    id: OpenAICompatibleModelID.GPT_5_5,
    name: 'OpenAI: GPT-5.5',
    tokenLimit: 1050000,
    enabled: true,
  },
  [OpenAICompatibleModelID.GPT_5_4]: {
    id: OpenAICompatibleModelID.GPT_5_4,
    name: 'OpenAI: GPT-5.4',
    tokenLimit: 1050000,
    enabled: true,
  },
  [OpenAICompatibleModelID.GPT_5_4_pro]: {
    id: OpenAICompatibleModelID.GPT_5_4_pro,
    name: 'OpenAI: GPT-5.4 Pro',
    tokenLimit: 1050000,
    enabled: true,
  },
  [OpenAICompatibleModelID.GPT_5_4_mini]: {
    id: OpenAICompatibleModelID.GPT_5_4_mini,
    name: 'OpenAI: GPT-5.4 Mini',
    tokenLimit: 400000,
    enabled: true,
  },
  [OpenAICompatibleModelID.GPT_5_4_nano]: {
    id: OpenAICompatibleModelID.GPT_5_4_nano,
    name: 'OpenAI: GPT-5.4 Nano',
    tokenLimit: 400000,
    enabled: true,
  },
  [OpenAICompatibleModelID.GPT_5_2]: {
    id: OpenAICompatibleModelID.GPT_5_2,
    name: 'OpenAI: GPT-5.2',
    tokenLimit: 400000,
    enabled: true,
  },
  [OpenAICompatibleModelID.GPT_5_2_Codex]: {
    id: OpenAICompatibleModelID.GPT_5_2_Codex,
    name: 'OpenAI: GPT-5.2 Codex',
    tokenLimit: 400000,
    enabled: true,
  },
  [OpenAICompatibleModelID.GPT_5_3_Chat_Latest]: {
    id: OpenAICompatibleModelID.GPT_5_3_Chat_Latest,
    name: 'OpenAI: GPT-5.3 Chat',
    tokenLimit: 128000,
    enabled: true,
  },
  [OpenAICompatibleModelID.GPT_5_1_chat_latest]: {
    id: OpenAICompatibleModelID.GPT_5_1_chat_latest,
