  ...
  return (
    ...
    >
      ...
      >
        ...
        {updatedVariables.map((variable, index) => (
          <div className="mb-4" key={index}>
            ...
            <textarea
              ...
              className="mt-1 w-full rounded-lg border border-neutral-500 px-4 py-2 text-neutral-900 shadow-sm dark:border-neutral-800 dark:border-opacity-50 dark:bg-[#40414F] dark:text-neutral-100"
              style={{ resize: 'none' }}
        ...
        <button
          className="mt-6 w-full rounded-lg border border-neutral-500 px-4 py-2 text-neutral-900 shadow-sm hover:bg-neutral-100 dark:border-neutral-800 dark:border-opacity-50 dark:bg-white dark:text-black dark:hover:bg-neutral-300"
